...
function makeSampleCars() {
  ...
  return [
    // ===== 仕入れ 4台 =====
    {
      id:'c1', num:'CAR-2025-001', maker:'スズキ', model:'ジムニー XC',
    ...
    {
      id:'c2', num:'CAR-2025-002', maker:'ダイハツ', model:'タント カスタム',
    ...
    {
      id:'c3', num:'CAR-2025-003', maker:'トヨタ', model:'ヤリス X',
    ...
    {
      id:'c4', num:'CAR-2025-004', maker:'ホンダ', model:'フィット ホーム',
    ...
    // ===== 再生中 3台 =====
    {
      id:'c5', num:'CAR-2025-005', maker:'トヨタ', model:'プリウス Z',
    ...
    {
      id:'c6', num:'CAR-2025-006', maker:'マツダ', model:'CX-3 XD',
    ...
    {
      id:'c7', num:'CAR-2025-007', maker:'スバル', model:'フォレスター X',
    ...
    // ===== 展示中 3台 =====
    {
      id:'c8', num:'CAR-2025-008', maker:'ホンダ', model:'N-BOX G',
    ...
    {
      id:'c9', num:'CAR-2025-009', maker:'マツダ', model:'CX-5 25S',
    ...
    {
      id:'c10', num:'CAR-2025-010', maker:'日産', model:'ノート オーラ',
    ...
    // ===== 納車準備 2台 =====
    {
      id:'c11', num:'CAR-2025-011', maker:'日産', model:'セレナ e-Power',
    ...
    {
      id:'c12', num:'CAR-2025-012', maker:'トヨタ', model:'アルファード S',
      year:'2022', color:'ブラック', size:'ミニバン', km:'18000', price:'4580000',
      purchaseDate:dateAddDays(t,-22), contract:1, deliveryDate:dateAddDays(t,3),
    ...
    // ===== 納車完了 1台 =====
    {
      id:'c13', num:'CAR-2025-013', maker:'スバル', model:'レヴォーグ STI',
      year:'2022', color:'WRブルー', size:'セダン', km:'18000', price:'3280000',
      purchaseDate:dateAddDays(t,-60), contract:1, deliveryDate:dateAddDays(t,-5),
